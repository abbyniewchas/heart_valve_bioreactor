...
/*
 * Need to put #define __mega__ line in dynamixel serial lib
 */
...
/*
  Serial1.print(time_ms);
  Serial1.print(", ");
  Serial1.print(servo_write);
  Serial1.print(", ");
  Serial1.print(pressure_abs_p1);
  Serial1.print(", ");
  Serial1.print(pressure_abs_p2);
  Serial1.print(", ");
  Serial1.print("\n");
  */
